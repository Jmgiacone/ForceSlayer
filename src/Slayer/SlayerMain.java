...
public class SlayerMain extends ActiveScript {
	...
	private class InitGameDialog extends JDialog {
		...
		public InitGameDialog() {
			...
			if (combatLevel >= 70
					&& Quest.isDoneWithQuest(Quest$QUEST.LOST_CITY)) {
				slayerMasters[index] = "Chaeldar";
				index++;
			}
			if (combatLevel >= 85 && slayerLevel >= 35
					&& Quest.isDoneWithQuest(Quest$QUEST.SMOKING_KILLS)) {
				slayerMasters[index] = "Sumona";
				index++;
			}
			if (combatLevel >= 100 && slayerLevel >= 50
					&& Quest.isDoneWithQuest(Quest$QUEST.SHILO_VILLAGE)) {
			...
			JCheckBox chckbxNpcContactFor = new JCheckBox(
					"NPC contact for new tasks?");
			...
			strengthPotionBox.setModel(new DefaultComboBoxModel<String>(
					new String[] { "Strength potion", "Super strength potion",
							"Extreme strength potion", "None" }));
			...
			attackPotionBox.setModel(new DefaultComboBoxModel<String>(
					new String[] { "Attack potion", "Super attack potion",
							"Extreme attack potion", "None" }));
			...
			defensePotionBox.setModel(new DefaultComboBoxModel<String>(
					new String[] { "Defense potion", "Super defense potion",
							"Extreme defense potion", "None" }));
			...
			foodBox.setModel(new DefaultComboBoxModel<String>(new String[] {
					"Trout", "Cod", "Pike", "Salmon", "Tuna", "Bass",
					"Lobster", "Swordfish", "Monkfish", "Shark", "Cavefish",
					"Sea turtle", "Manta ray", "Tuna potato", "Rocktail" }));
			...
			summoningFamiliarBox.setModel(new DefaultComboBoxModel<String>(
					new String[] { "Void spinner (34)", "Bunyip (68)",
							"Moss titan (79)", "Ice titan (79)",
							"Fire titan (79)", "Unicorn stallion (88)",
							"Pack yak (96)" }));

			JComboBox<String> prayerPotionBox = new JComboBox<String>();
			prayerPotionBox.setModel(new DefaultComboBoxModel<String>(
					new String[] { "Prayer potion", "Super prayer potion" }));
			...
			JCheckBox chckbxPrayerRenewals = new JCheckBox(
			...
			JCheckBox chckbxRingOfWealth = new JCheckBox(
			...
			JCheckBox chckbxBuryBonesscatterAshes = new JCheckBox(
			...
			JLabel lblBeforeStartingThe = new JLabel(
					"Before starting the script, make sure you have all of your settings setup correctly.");

			JLabel lblForceSlayerIs = new JLabel(
					"Force Slayer is in alpha, therefore you should expect bugs. If you encounter any");

			JLabel lblBugsPleaseReport = new JLabel(
					"bugs, please report them to 9Ox or Jdog653 via private message on powerbot or");

			JLabel lblCreateANew = new JLabel(
					"create a new post on the official script topic explaining the bug in detail.");

			JButton btnVisitOfficialScript = new JButton(
					"Visit official script thread");
